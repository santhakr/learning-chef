...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "santhakr-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/santhakr"
  #   chef.validation_client_name = "santhakr-validator"
  #   chef.validation_key_path = ".chef/santhakr-validator.pem"
  # end
end
